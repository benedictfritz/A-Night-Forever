package entities
{
	...
	private function floatLeft(endX:Number):void {
	    ...
	    floatLeftTween.tween(this, "x", endX + this.width, PLAYER_PICKUP_TIME, Ease.sineInOut);
	    FP.world.addTween(floatLeftTween, true);
	}

	private function floatUp():void {
	    floatUpTween = new VarTween(floatDown);
	    floatUpTween.tween(this, "y", this.y - 40, PLAYER_PICKUP_TIME/2, Ease.sineInOut);
	...
	private function floatDown():void {
	    ...
	    floatDownTween.tween(this, "y", playerY, PLAYER_PICKUP_TIME/2, Ease.sineInOut);
